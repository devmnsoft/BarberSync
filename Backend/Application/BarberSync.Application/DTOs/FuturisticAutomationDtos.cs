...
public record ProfessionalPerformanceDto(Guid ProfessionalId, string ProfessionalName, decimal PrecisionScore, decimal EfficiencyScore, decimal SatisfactionScore, decimal UpsellRate);
...
public record FuturisticOperationsSnapshotDto(
    ...
    IReadOnlyCollection<ProfessionalPerformanceDto> ProfessionalMetrics,
