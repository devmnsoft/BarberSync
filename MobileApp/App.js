...
export default function App() {
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.bg }} contentContainerStyle={{ padding: spacing.xl, paddingTop: 58 }}>
      ...
      <Card><Text style={{ fontSize: 18, fontWeight: '900', color: colors.ink }}>Serviços publicados no Mobile</Text><Text style={{ color: colors.muted, marginTop: 6 }}>Mesma curadoria visual do Admin 7.0, com toggles de canal simulados.</Text><View style={{ flexDirection: 'row', flexWrap: 'wrap' }}><Pill>✂️ Corte R$ 45</Pill><Pill>💈 Combo R$ 78</Pill><Pill>🧴 Hidratação R$ 89</Pill></View></Card>
