...
export function CashbackScreen() {
  return <View style={{ flex: 1, backgroundColor: colors.bg, padding: spacing.lg, gap: spacing.md }}>
    ...
    <AppCard><Text style={{ fontSize: 20, fontWeight: '800', color: colors.text }}>CashbackScreen</Text><Text style={{ color: colors.muted, marginTop: 8 }}>Serviços, agendamentos, cashback e perfil com identidade visual BarberSync 2.0.</Text></AppCard>
