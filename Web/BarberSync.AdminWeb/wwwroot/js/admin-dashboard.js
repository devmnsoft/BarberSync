(() => {
  ...
  ['public:leadCreated','appointment:created','appointment:checkedIn','serviceOrder:paid','stock:changed','review:created','campaign:created','kiosk:attendanceCreated','commercialFlow:completed','commercialFlow:paymentDone','commercialFlow:reviewCreated','dashboard:refresh'].forEach(ev=>window.BarberSyncEventBus?.on(ev, refreshDashboardFromStore));
