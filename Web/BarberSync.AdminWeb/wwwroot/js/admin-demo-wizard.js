(() => {
  ...
  const steps = [
    ...
    { id:'publicweb', title:'Abrir PublicWeb', description:'Apresente site público com serviços, profissionais e formulário de agendamento.', action:'Abrir PublicWeb', href:'/Admin/PublicSite', external:true, tip:'Mostre o canal de captação sem expor a API interna.' },
    { id:'publicbooking', title:'Realizar agendamento público', description:'Simule envio do formulário e protocolo demo via /PublicApi/appointments.', action:'Validar agendamento', href:'/Admin/PublicSite', external:true, tip:'Explique que o lead vira agenda e alimenta a operação.' },
    { id:'kiosk', title:'Abrir Kiosk', description:'Inicie o Totem em /Kiosk/Services com serviços e profissionais via /KioskApi.', action:'Abrir Kiosk', href:'/Admin/Kiosk', external:true, tip:'Mostre autoatendimento para reduzir fila da recepção.' },
    { id:'kioskflow', title:'Concluir fluxo do Totem', description:'Valide cliente, profissional, confirmação, pagamento mock, sucesso e avaliação.', action:'Marcar Totem OK', href:'/Admin/Kiosk', external:true, tip:'Destaque sessionStorage, botão voltar, cancelar e reiniciar.' },
