(() => {
  ...
  function initPublicSite() {
    ...
    q('[data-open-public]')?.addEventListener('click', () => { const params = new URLSearchParams({ title: state.publicSite.heroTitle, subtitle: state.publicSite.heroSubtitle, cta: state.publicSite.ctaPrimary, company: state.platform.publicName, slogan: state.platform.slogan, primary: state.platform.primary, secondary: state.platform.secondary }); window.open(`/Admin/PublicSite?${params.toString()}`, '_blank', 'noopener'); });
  ...
  function initKiosk() {
    ...
    q('[data-open-kiosk]')?.addEventListener('click', () => { const params = new URLSearchParams({ message: state.kiosk.message, title: state.platform.kioskName, primary: state.platform.primary, secondary: state.platform.secondary, highContrast: String(state.kiosk.highContrast), largeFont: String(state.kiosk.largeFont) }); window.open(`/Admin/Kiosk?${params.toString()}`, '_blank', 'noopener'); });
