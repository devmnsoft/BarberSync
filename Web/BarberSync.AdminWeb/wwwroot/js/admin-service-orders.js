(() => {
  ...
  function renderOrder() {
    ...
    q('#posReadonly').hidden = !order || canEdit; qa('#couponForm input, #couponForm button, #cashbackForm input, #cashbackForm button').forEach(control => { control.disabled = !canEdit; });
