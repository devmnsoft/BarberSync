...
check 'technical ID text field' "<input[^>]+type=['\"]text['\"][^>]+name=['\"][^'\"]*(tenant|branch|client|professional|service|appointment|serviceOrder|resource|room|chair|package|coupon|payment|schedule|waitlist)Id['\"]" Web MobileApp Totem
